...
typedef enum LibaflQemuCommand {
  ...
  LIBAFL_QEMU_COMMAND_SMM_REPORT_DXE_BUFFER = 34,
  LIBAFL_QEMU_COMMAND_SMM_REPORT_REDZONE_BUFFER_ADDR = 35,
  LIBAFL_QEMU_COMMAND_SMM_GET_SAVE_REGISTER_FUZZ_DATA = 36,
  LIBAFL_QEMU_COMMAND_SMM_REPORT_READYTOLOCK_START = 37,
  LIBAFL_QEMU_COMMAND_SMM_REPORT_READYTOLOCK_END = 38,
  LIBAFL_QEMU_COMMAND_SMM_REPORT_CONFLICT_DXE_PROTOCOL = 39,
...
typedef enum LibaflQemuEndStatus {
  ...
  LIBAFL_QEMU_END_SMM_INIT_PREPARE = 11,
} LibaflExitEndParams;
...
#define LIBAFL_QEMU_SMM_SMI_ENTER(guid_addr, target_addr) _libafl_backdoor_call2(LIBAFL_QEMU_COMMAND_SMM_SMI_ENTER,guid_addr, target_addr)
...
#define LIBAFL_QEMU_SMM_REPORT_SMI_INFO(index,guid_addr,addr) _libafl_backdoor_call3(LIBAFL_QEMU_COMMAND_SMM_REPORT_SMI_INFO,index,guid_addr,addr)
...
#define LIBAFL_QEMU_SMM_REPORT_DXE_BUFFER(addr,size) _libafl_backdoor_call2(LIBAFL_QEMU_COMMAND_SMM_REPORT_DXE_BUFFER,addr,size)
#define LIBAFL_QEMU_SMM_REPORT_REDZONE_BUFFER_ADDR(addr) _libafl_backdoor_call1(LIBAFL_QEMU_COMMAND_SMM_REPORT_REDZONE_BUFFER_ADDR,addr)
#define LIBAFL_QEMU_SMM_GET_SAVE_REGISTER_FUZZ_DATA(addr,size) _libafl_backdoor_call2(LIBAFL_QEMU_COMMAND_SMM_GET_SAVE_REGISTER_FUZZ_DATA,addr,size)
#define LIBAFL_QEMU_SMM_REPORT_READYTOLOCK_START() _libafl_backdoor_call0(LIBAFL_QEMU_COMMAND_SMM_REPORT_READYTOLOCK_START)
#define LIBAFL_QEMU_SMM_REPORT_READYTOLOCK_END() _libafl_backdoor_call0(LIBAFL_QEMU_COMMAND_SMM_REPORT_READYTOLOCK_END)

#define LIBAFL_QEMU_SMM_REPORT_CONFLICT_DXE_PROTOCOL(addr) _libafl_backdoor_call1(LIBAFL_QEMU_COMMAND_SMM_REPORT_CONFLICT_DXE_PROTOCOL,addr)

#define LIBAFL_QEMU_SMM_REPORT_SMI_INVOKE_INFO(smi_index,smi_times) _libafl_backdoor_call2(LIBAFL_QEMU_COMMAND_SMM_REPORT_SMI_INVOKE_INFO,smi_index,smi_times)
